...
public class MessageActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_image = findViewById(R.id.profileimage_message);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!message.equals("")) {
                    ...
                    Toast.makeText(MessageActivity.this, "Can't send empty message", Toast.LENGTH_LONG).show();
                }
                send_text.setText("");
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.d("MessageActivity",user.getUsername());
    ...
    {
//        Log.d("MessageActivity2",fuser.getUid());
